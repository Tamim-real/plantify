...
const Navbar = () => {
  ...
  const defaultAvatar =
    "https://cdn-icons-png.flaticon.com/512/847/847969.png"; // fallback image
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 text-gray-700 font-medium">
            ...
            <NavLink to="/community" className="hover:text-green-600">Community</NavLink>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-lg border-t border-gray-100">
          <div className="flex flex-col items-center space-y-4 py-4">
            ...
            <NavLink to="/plants" className="text-gray-700 hover:text-green-600">
              Plants
            </NavLink>
            <NavLink to="/my-profile" className="text-gray-700 hover:text-green-600">
              My Profile
            </NavLink>
            <NavLink to="/community" className="text-gray-700 hover:text-green-600">
              Community
            </NavLink>
